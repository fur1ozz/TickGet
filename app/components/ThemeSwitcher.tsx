...
export function ThemeSwitcher() {
    ...
    return (
        <>
            {theme === 'dark' ? (
                <button className="text-primary-700 hover:text-primary-800 mr-4" onClick={() => setTheme('light')}>
                ...
                <button className="text-primary-700 hover:text-primary-800 mr-4" onClick={() => setTheme('dark')}>
