...
export function ThemeSwitcher() {
    ...
    return (
        <>
            {theme === 'dark' ? (
                <button className="text-secondary-100 hover:text-secondary-200 mr-4" onClick={() => setTheme('light')}>
                ...
                <button className="text-secondary-100 hover:text-secondary-200 mr-4" onClick={() => setTheme('dark')}>
